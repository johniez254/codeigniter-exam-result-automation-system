...
$config_controller_path='../application/controllers/Login.php';
...
<!DOCTYPE html>
    <head>
		...
		<title>Install | Exam Result Automation (ERA)</title>
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="mailbox">
                                    ...
                                    <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                                        ...
                                        <li class="active"><button style="text-align:left; padding:10px;" class="btn btn-blue btn-block"><i class="fa fa-bars"></i> Requirements</button>
                                        </li>
    ...
    <a href="index.php?o=install"><button class="btn btn-blue btn-square pull-right" type="button">Next <i class="fa fa-arrow-right"></i></button></a><?php /*?>
    <button  style="margin-left:2px;" class="btn btn-blue btn-square pull-right disabled" type="button"><i class="fa fa-arrow-left"></i> Previous</button><?php */?>
...
<!DOCTYPE html>
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="mailbox">
                                    ...
                                    <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                                        ...
                                        <li class="active"><a href="index.php?o=require" style="text-align:left; background-color:#4993c3; border-color:#3f8dc0;" class="btn btn-blue"><i class="fa fa-bars"></i> Requirements</a>
                                        </li>
                                        <li class="active"><a href="index.php?o=install" style="text-align:left; background-color:#4993c3; border-color:#3f8dc0;" class="btn btn-blue"><i class="fa fa-wrench"></i> Installaion</a>
                                        </li>
                                        </li>
                                        <li><button style="text-align:left; padding:10px;" class="btn btn-blue btn-block"><i class="fa fa-check"></i> Complete</button>
                                        </li>
                                        <li class="nav-divider"></li>
                                    </ul>
 ...
 <center><strong><i class="fa fa-check"></i> Installation was successfull.</strong></center>
                                    ...
                                    <br>
                                    <p>(<em><strong>Note:</strong> You can always change your login credentials once you have logged in under your <strong>profile</strong> page.</em>)
                                    </p>
                                    <hr>

                        
     
    <a href="../"><button class="btn btn-blue btn-square pull-right" type="button">Finish <i class="fa fa-arrow-right"></i></button></a>
    <button  style="margin-left:2px;" class="btn btn-blue btn-square pull-right disabled" type="button"><i class="fa fa-arrow-left"></i> Previous</button>
...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		if($database->create_database($_POST) == false) {
			...
			$message = $core->show_message('error',"The main configuration file could not be written, please chmod application/config/Login.php file to 777");
		}
      ...
      <div class="row">
                    <div class="col-lg-12">
                        <div class="portlet portlet-blue">
                            <div class="portlet-body">
                                ...
                                <div id="mailbox">
                                    ...
                                    <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                                        ...
                                        <li><button style="text-align:left; padding:10px;" class="btn btn-blue btn-block"><i class="fa fa-wrench"></i> Installation</button>
                                        </li>
                                        <li><button style="text-align:left; padding:10px;" class="btn btn-white btn-block disabled"><i class="fa fa-check"></i> Complete</button>
                                        </li>
                                        <li class="nav-divider"></li>
                           ...
                           <ol type="i">
                           		<li>Modify <code>line 23</code> of <code><?php echo $config_controller_path; ?></code> where there is <code><em><strong>$this->dbutil->database_exists('your_database_name')</strong></em></code>. <br>Replace <code><em><strong>your_database_name</strong></em></code> with the name of the database you created.</li>
                                ...
                                <li>Skip the installation wizard. <a class="text-blue" href="../">Click here</a> to skip insatllation.</li>
                           </ol>
                            </p>       
...
<div class="well">
     ...
     <button class="btn btn-blue btn-square pull-right" type="submit">Next <i class="fa fa-arrow-right"></i></button>
    <a href="index.php?o=require"><button  style="margin-left:2px;" class="btn btn-blue btn-square pull-right" type="button"><i class="fa fa-arrow-left"></i> Previous</button></a>
		  </form>
          <br><br>
          </div>
