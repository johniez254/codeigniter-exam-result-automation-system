    ...
    ULTRA_SETTINGS.dataTablesInit = function() {
        ...
        if ($.isFunction($.fn.dataTable)) {
            ...
            $.extend(true, $.fn.dataTable.defaults, {
                "sDom": "<'row'<'col-md-2'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
				//"sDom": "<'row'<'col-sm-5'l><'col-sm-5'f>r>t<'row'<'col-sm-5'i><'col-sm-7'p>>",
                ...
                tableElement.dataTable({
                    ...
                    "oTableTools": {
                        "aButtons": [{
							...
							"sButtonText": "<a href='#' target='_blank' style='text-decoration:none;'>Print</a>",
							"aButtons": []
