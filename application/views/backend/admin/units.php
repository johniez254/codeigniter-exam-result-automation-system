...
<div class="col-lg-8">
    <section class="box purple">
        <header class="panel_header">
            <h2 class="title pull-left">All Units (<?PHP echo $total_units;?>)</h2>
                ...
                <div class="row">
                    ...
                    <?PHP if($total_units!='0'){;?>
                        <div style=" overflow:visible; display:block; position:relative;">
                            <a href="<?php echo base_url()?>download/units" target="_blank" style="margin-bottom:-25px;"  class="btn btn-info btn-sm  pull-right">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if($assigned=="0"){
                                        echo "<span class='badge badge-warning'>Unassigned</span>
                                        ";
                                    }else{
                                        echo"<span class='badge badge-info'>Assigned</span>";
                                    }?>
                                </td>
                            <td>
                                <div class="btn-group">
