                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <ul class="nav nav-tabs primary">
                                                    <li class="active">
                                                        <a href="#home-1" data-toggle="tab">
                                                            <i class="fa fa-users"></i> All Lectures  (<?PHP echo $this->db->count_all("lecturers");?>)
                                                        </a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content primary">
                                                    <div class="tab-pane fade in active" id="home-1">
                                                        ...
                                                        <div>
                                                        <?PHP if($this->db->count_all("lecturers")!='0'){;?>
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    <div class="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="showCustomAjaxModal('<?php echo base_url();?>admin/lecturers_crud/edit/<?php echo $lecturer_id;?>')"><small><i class="fa fa-edit"></i> Edit</small></a></li>
