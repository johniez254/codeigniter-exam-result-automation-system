<?php
foreach($student_id->result() as $row):
$id=$row->login_id;
endforeach;
                                    ...
                                    <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <form action="<?php echo base_url()?>admin/result_crud/student_pdf/<?php echo urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode(urlencode(base64_encode($id))))))))?>" method="post" target="_blank">
                                                <input type="hidden" id="base_url" value="<?php echo base_url(); ?>">
                                                <input type="hidden" id="stud_log_id" value="<?php echo $id; ?>">
                                                	<div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                            					...
                                            					<div class="col-sm-10">
                                                                 <select name="s2example-1" id="s2example-1" onchange="return admin_get_result(this.value)">
                                                                    <option></option>
