                            	...
                            	<div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="uprofile-image">
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url()?>student/edit_image/<?php echo $id?>')"><img src="<?php echo $this->stud->get_image_url('user',$id);?>" class="img-responsive"></a>
                                        </div>
                                           
                                        
                                        <div class="uprofile-buttons">
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url()?>student/edit_image/<?php echo $id?>')" class="btn btn-md btn-primary">Edit Image</a>
                                        </div>
                                    ...
                                    <div class="col-md-9 col-sm-8 col-xs-12">
                                        ...
                                        echo form_open("student/validate_password", $attributes);?>
