...
$cs=array('lecturer_id'=>$lecturer_id);
$this->db->select('*');
...
<div class="col-lg-12">
									<div class="well primary">
                                            <h3><span class="semi-bold"><strong>School : </strong> <?php echo $school_name; ?></span></h3>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-8 col-xs-12">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                <h4><strong><?php echo $count_courses;?></strong></h4>
                                    ...
                                    <div class="col-md-4 col-sm-8 col-xs-12">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                <h4><strong><?php echo $count_results;?></strong></h4>
